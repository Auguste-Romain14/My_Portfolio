        ...
        <Row>
          <Col lg={6}>
            <div className=" presentation">
              ...
              <p>
                Je suis un développeur Web Fullstack qui construit des sites Web
                et des applications Web qui mènent au succès de l'ensemble du
                produit.
                <br />
                <br />
                Jetez un coup d'œil à certains de mes travaux dans la section
                Projets. J'aime aussi partager du contenu lié à ce que j'ai
                appris au fil des ans dans le domaine du développement Web afin
                d'aider les autres membres de la communauté des développeurs.
                N'hésitez pas à vous connecter ou à me suivre sur &emsp;
                <a
                ...
                &emsp;où je publie du contenu utile lié au développement web et
                à la programmation.
                <br />
                <br />
                Je suis ouvert aux opportunités d'emploi où je peux contribuer,
                apprendre et grandir. Si vous avez une bonne opportunité qui
                correspond à mes compétences et à mon expérience, n'hésitez pas
                à me contacter.
                <br />
                <br />
